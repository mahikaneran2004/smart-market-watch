...
const mockEvents = [
  {
    ...
    reasoning: "Brent crude expansion directly boosts upstream Gross Refining Margins (GRM) across integrated refiners.",
    priceImpactExplanation: "Positive realization delta on crude basket supports immediate stock re-rating.",
    rippleImpacts: [
      { symbol: "RELIANCE", impactDirection: "POSITIVE", rationale: "Refinery margins expand", sector: "Energy" },
      { symbol: "ASIANPAINT", impactDirection: "NEGATIVE", rationale: "Solvent chemical cost surge", sector: "Paints" },
    ],
  },
  {
    id: "ev-2",
    ...
    reasoning: "Status quo policy preserves existing IT service billing structures without operational compliance disruption.",
    priceImpactExplanation: "Low direct price volatility expected as market already priced in status quo outcome.",
    rippleImpacts: [],
  },
  {
    id: "ev-3",
    ...
    occurredAt: new Date(Date.now() - 75 * 60 * 1000).toISOString(),
    confidence: 0.89,
    sentiment: "NEUTRAL",
    sentimentScore: 0.15,
    ...
    reasoning: "Rate stability reduces USD/INR cross-currency volatility and stabilizes corporate borrowing yields.",
    priceImpactExplanation: "Supports valuations for foreign institutional investment flows into benchmark heavyweights.",
    rippleImpacts: [],
  },
  {
    id: "ev-4",
    ...
    reasoning: "Enterprise GenAI modernization budgets expanding deal total contract value (TCV) in key geographies.",
    priceImpactExplanation: "Accelerates forward revenue visibility and margins for top-tier Indian IT exporters.",
    rippleImpacts: [],
  },
];
      ...
      signals: [
        {
          ...
          macroScore: 0.40,
          horizon: "SWING",
          rationale: "Volume breakout + Upstream GRM expansion with bullish SMA20 golden cross",
        },
        {
          id: "sig-2",
          symbol: "TCS",
          ...
          macroScore: -0.10,
          horizon: "INTRADAY",
          rationale: "RSI mean-reversion at support balanced against macro FX headwinds",
        },
      ],
    });
  }
